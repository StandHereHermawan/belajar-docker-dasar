...
docker container create --name nginx-template-for-volume-backup-purpose --mount "type=bind,source=/home/arief-karditya/Project-Belajar-In-Linux/Tools-For-Developing/Docker/belajar-docker-dasar/backup,destination=/backup" --mount "type=volume,source=mongo-data,destination=/data" nginx:latest
...
docker container run --rm --name ubuntu-template-for-volume-backup-purpose --mount "type=bind,source=/home/arief-karditya/Project-Belajar-In-Linux/Tools-For-Developing/Docker/belajar-docker-dasar/backup,destination=/backup" --mount "type=volume,source=mongo-data,destination=/data" ubuntu:jammy tar cvf /backup/backup-1.tar.gz /data
